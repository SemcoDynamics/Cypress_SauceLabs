...
describe('Select Single and Multi-Selects', () => {
  ...
  it('Loop through each Single Selection', () => {
      cy.visit('https://kitchen.applitools.com/ingredients/select');
...
describe('Multi Selectiopns', () => {
  it.only('Select multiple selection', () => {
    cy.visit('https://kitchen.applitools.com/ingredients/select');
    cy.get('#spices-select-multi').select(['chili-powder', 'garlic']).invoke('val').should('deep.equal',['chili-powder', 'garlic'] )
